...
class SolicitudesController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $request->validate([ // Valida los datos de entrada
            ...
            'dpi' => 'integer|unique:solicitudes,dpi,' . $solicitud->id, // Validación única para DPI, excluyendo el ID actual
            'telefono' => 'integer',
            'direccion' => 'string',
            'ingresos' => 'numeric',
    ...
    public function update(Request $request, string $id)
    {
        ...
        $request->validate([ // Valida los datos de entrada
            ...
            'dpi' => 'required|integer|unique:solicitudes,dpi,' . $solicitud->id, // Validación única para DPI, excluyendo el ID actual
